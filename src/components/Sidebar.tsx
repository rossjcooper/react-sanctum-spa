	...
	return (
		<div className="bg-gray-800 text-white flex-1 w-40 flex flex-col">
			...
			<div className="flex flex-col flex-1 p-1">
				<SideBarLink to='/'><AiOutlineDashboard className="inline-block mr-1 align-text-bottom"/> Dashboard</SideBarLink>
				<SideBarLink to='/clients'><AiOutlineTeam className="inline-block mr-1 align-text-bottom"/> Clients</SideBarLink>
